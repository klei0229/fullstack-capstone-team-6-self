  ...
  return (
    <Card sx={{ width: '100%' }}>
      <CardActionArea>
        ...
        />
        <CardContent>
          <Typography gutterBottom variant="h6" component="div" sx={{fontSize:menuPreferences.itemNameFontSize}}>
            {props.name}
          </Typography>
          <Typography variant="body2" color="text.secondary" sx={{fontSize:menuPreferences.descriptionNameFontSize}}>
            {props.description}
          </Typography>
        </CardContent>
      </CardActionArea>
